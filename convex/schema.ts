...
export default defineSchema({
  ...
  workers: defineTable(Worker)
    ...
    .index('boss_Id', ['bossId', 'type'])
    .index('userId', ['userId', 'type'])
  ...
  stars: defineTable(Star)
    .index('by_organization_id', ['organizationId'])
    .index('by_workspace_id', ['workspaceId'])
    .index('by_assignee_id', ['assignedTo']),
  ...
  deletionRequests: defineTable(DeleteAccount).index('by_user', [
    'userId',
    'status',
  ]),
