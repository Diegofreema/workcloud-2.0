...
export const RenderBubble = ({
  ...
  const renderContent = () => {
    ...
    } else if (currentMessage.fileType === 'audio' && currentMessage.fileUrl) {
      return (
        <View
          style={
        ...
        >
          <VoiceNotePlayer
            audioUri={currentMessage.fileUrl}
            isFromMe={isSent}
          />
        </View>
      );
      ...
      >
        ...
        >
          <ChatMenu
            ...
            trigger={
              <CircleChevronDown
                color={isSent ? backgroundColor : colors.dialPad}
                size={20}
